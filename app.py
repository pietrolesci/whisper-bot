...
class Flow(L.LightningFlow):
    def __init__(self):
        ...
        self.telegram_bot = TelegramBot(
            drive=self.drive, cloud_compute=L.CloudCompute("default")
        )
        self.whisper_endpoint = WhisperServer(
            drive=self.drive,
            cloud_compute=L.CloudCompute("cpu-medium", idle_timeout=10),
        )
...
app = L.LightningApp(
    Flow(), log_level="info", flow_cloud_compute=L.CloudCompute("cpu-small")
)
